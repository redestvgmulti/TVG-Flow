    ...
    async function addSource() {
        ...
        try {
            ...
            if (tipo === 'instagram') {
                ...
                const instagramUrl = new URL(finalUrl)
                if (instagramUrl.protocol !== 'https:' || !['instagram.com', 'www.instagram.com'].includes(instagramUrl.hostname)) {
                    throw new Error('INSTAGRAM_URL_INVALID')
                }
