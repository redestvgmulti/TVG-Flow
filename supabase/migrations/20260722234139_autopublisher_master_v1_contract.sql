...
DROP POLICY IF EXISTS visual_titles_tenant_isolation ON ap.visual_titles;
...
DROP POLICY IF EXISTS master_render_controls_tenant_isolation ON ap.master_render_controls;
...
DROP POLICY IF EXISTS master_render_configs_tenant_isolation ON ap.master_render_configs;
...
DROP POLICY IF EXISTS template_render_profiles_tenant_isolation ON ap.template_render_profiles;
...
DROP TRIGGER IF EXISTS trg_ap_visual_titles_updated_at ON ap.visual_titles;
...
DROP TRIGGER IF EXISTS trg_ap_master_render_controls_updated_at ON ap.master_render_controls;
...
DROP TRIGGER IF EXISTS trg_ap_master_render_configs_updated_at ON ap.master_render_configs;
...
DROP TRIGGER IF EXISTS trg_ap_template_render_profiles_updated_at ON ap.template_render_profiles;
