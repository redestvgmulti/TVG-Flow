-- Controlled enablement for Individual Feed in the operational tenant only.
-- The block is intentionally idempotent but remains fail-closed.
DO $enable$
DECLARE
    v_master_id uuid;
...
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'INDIVIDUAL_FEED_ENABLE_FAILED';
    END IF;
END;
$enable$;
